            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        ...
                        dcc.RadioItems(['gross income', 'Rating'], 'gross income',inline=True,id='main_variable', inputStyle={'margin-right': '5px', 'margin-left': '20px'}),
...
def render_graphs(cities, main_variable):
    ...
    fig_payment = px.bar(df_payment, y='Payment', x=main_variable, barmode='group', orientation='h')
    ...
    for fig in [fig_city, fig_gender, fig_payment, fig_income_date]:
